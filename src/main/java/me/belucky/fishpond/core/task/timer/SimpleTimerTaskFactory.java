 ...
 */
package me.belucky.fishpond.core.task.timer;
...
public class SimpleTimerTaskFactory {
	...
	public static Future<?> schedule(TimerTask task, long initialDelay,long period,String expectStart){
		return executorService.schedule(task, initialDelay, period, expectStart);
	}
